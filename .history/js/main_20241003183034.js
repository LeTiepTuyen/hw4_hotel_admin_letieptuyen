...
function renderAdminRooms() {
  ...
  rooms.forEach((room) => {
    ...
    <button class="p-2 hover:bg-blue-100 rounded-full" onclick="showUpdateForm('${room.id}')">
        <img src="../assets/images/update-icon2.png" alt="Update" class="w-6 h-6">
    </button>
    <button class="p-2 hover:bg-red-100 rounded-full" onclick="deleteRoom('${room.id}'); renderAdminRooms(); renderHomepageRooms();">
        <img src="../resources/delete-icon.png" alt="Delete" class="w-6 h-6">
    </button>
</td>
    </tr>
`;
