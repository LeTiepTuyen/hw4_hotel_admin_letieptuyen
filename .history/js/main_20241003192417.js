    ...
    <tr>
        ...
        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
          <div class="w-16 h-16 overflow-hidden flex items-center justify-center">
            <img src="${room.imageUrl.value}" alt="${room.name}" style="width: 7%; height: 7%; object-fit: contain;">
          </div>
        </td>
        ...
        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 flex items-center justify-center space-x-4">
          ...
          <button class="p-4 hover:bg-red-100 rounded-full" onclick="deleteRoom('${room.id}'); renderAdminRooms(); renderHomepageRooms();">
