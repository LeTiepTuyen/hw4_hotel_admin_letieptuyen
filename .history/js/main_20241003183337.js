  ...
  rooms.forEach((room) => {
    ...
    <tr>
        ...
        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 flex items-center justify-center space-x-4">
          <button class="p-3 hover:bg-blue-100 rounded-full" onclick="showUpdateForm('${room.id}')">
            <img src="../assets/images/update-icon.png" alt="Update" class="w-6 h-6">
          </button>
          <button class="p-3 hover:bg-red-100 rounded-full" onclick="deleteRoom('${room.id}'); renderAdminRooms(); renderHomepageRooms();">
